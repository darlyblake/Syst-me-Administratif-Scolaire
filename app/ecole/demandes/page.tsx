...
export default function SchoolDemandesPage() {
  ...
  return <div className="mx-auto max-w-7xl space-y-6">
    ...
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_420px]">
      ...
      </CardContent></Card> : <CardContent className="flex min-h-[360px] flex-col items-center justify-center text-center text-pierre"><FileCheck2 className="mb-3 h-10 w-10" /><p className="font-medium text-encre">Sélectionnez une demande</p><p className="mt-1 max-w-sm text-sm">Vous pourrez consulter les pièces jointes, traiter la demande et choisir entre envoi numérique et retrait sur place.</p></CardContent>}</Card>
    </div>
  </div>
}
