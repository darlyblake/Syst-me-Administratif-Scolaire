...
export default function EmploiDuTempsClient() {
  ...
  const genererHeuresDynamiques = useCallback(() => {
    ...
    const horairesPersonnalises = (typeof window !== "undefined" ? localStorage : { getItem: ()=>null, setItem: ()=>{}, removeItem: ()=>{}, clear: ()=>{} } as any).getItem('horairesPersonnalises')
  ...
  const ajouterLigneHeure = () => {
    ...
    (typeof window !== "undefined" ? localStorage : { getItem: ()=>null, setItem: ()=>{}, removeItem: ()=>{}, clear: ()=>{} } as any).setItem('horairesPersonnalises', JSON.stringify(nouvellesHeures))
