...
import { Archive, BarChart3, Banknote, BookOpen, CalendarDays, CheckSquare, ClipboardList, FileText, FolderOpen, GraduationCap, LayoutDashboard, LogOut, Settings, Timer, Users, UserRound, Wrench, LifeBuoy, Loader2, Inbox } from "lucide-react"
...
export default function Sidebar({ isOpen, setIsOpen }: SidebarProps) {
 ...
 const navItems=[
  ...
  {section:"Finances",items:[{href:"/ecole/comptabilite",label:"Comptabilité",icon:BarChart3,permission:"finance.view"}]},
